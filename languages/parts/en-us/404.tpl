...
<head>
	...
	<style>body{background: #2B9D48 url(https://<%= htmlWebpackPlugin.options.data.imgDomain %>/logo.png) 20% 0 no-repeat;color: #FFF;} .container{margin-top: 20vh;} a, a:hover{color: #FFF;}
		.mask{background-color: rgba(43, 157, 72, 0.5);padding:5px;} #webserver {position: absolute; bottom: 0; width: 100%; text-align: center;}</style>
	<script>
...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<div class="mask">
				<h1 class="display-3"><i class="fa fa-ban"></i> 404 Not found</h1>
				<p class="lead">Sorry, the requested page was not found.</p>
				<p>Either this URL was mistyped or what content has been removed.</p>
