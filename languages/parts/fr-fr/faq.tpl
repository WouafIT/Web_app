...
<div class="modal-body">
	...
	<h4>Quelles sont les limites de contenu d'un Wouaf ?</h4>
	...
	<ul>
		...
		<li>... et évidemment le contenu de votre Wouaf doit respecter les
			<a href="/about/" data-href="about" data-show="modal" data-target="#modalWindow">conditions d'utilisation</a>.</li>
	</ul>

	<h4>Comment puis-je modifier un Wouaf ?</h4>
	...
	<h4>Pourquoi ces contraintes ?</h4>
	...
	<ol>
		...
		<li>Cette opération prendra quelques minutes et une fois effectuée, vous recevrez un email.</li>
	...
	<h4>J'ai du contenu que je souhaite importer automatiquement dans Wouaf IT, comment faire ?</h4>
	...
	<h4>Je souhaite aider au développement de Wouaf IT, comment faire ?</h4>
