...
<div class="modal-body">
	<p>Wouaf IT © <%= htmlWebpackPlugin.options.data.year %> par Sébastien PAUCHET.</p>
	<hr />
	...
	<ul>
		<li>Ne publiez pas de contenu choquant ou pouvant porter atteinte à autrui (appels à la haine, propos xénophobes ou homophobes, diffamation, pornographie, etc.).</li>
