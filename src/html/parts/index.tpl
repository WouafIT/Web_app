<div id="sb-site">
	...
	<div id="add-zone" hidden>
		<div class="map-btns">
			<div class="map-btn search" title="<%= htmlWebpackPlugin.options.i18n['Search'] %>"><i class="fa fa-search" aria-hidden="true"></i></div>
			<div class="map-btn add" title="<%= htmlWebpackPlugin.options.i18n['Add a Wouaf'] %>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></div>
		</div>
		<div class="add-btns">
				...
				<form>
						...
						<div class="col-lg-6">
							...
							<div class="input-group">
								...
								<input type="text" data-field="date" data-startend="start" class="form-control date-period"
									   data-startendelem=".date-period" id="start" readonly placeholder="<%= htmlWebpackPlugin.options.i18n['Start'] %>" />
							</div>
						</div>
						<div class="col-lg-6">
							...
							<div class="input-group">
								...
								<input type="text" data-field="date" data-startend="end" class="form-control date-period"
									   data-startendelem=".date-period" id="end" readonly placeholder="<%= htmlWebpackPlugin.options.i18n['End'] %>" />
							</div>
						</div>
					</fieldset>
					<fieldset class="form-group row">
						<label for="text-content"><%= htmlWebpackPlugin.options.i18n['Keywords?'] %></label>
						<div class="input-group">
							<div class="input-group-addon"><i class="fa fa-i-cursor"></i></div>
							<input type="text" class="form-control" id="text-content" maxlength="100"
					...
					<fieldset class="form-group row">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="hashtag" maxlength="100"
	...
	<footer class="container">
		<nav class="text-center">
			...
			<span class="line">
				...
				<i class="fa fa-twitter"></i>&nbsp;<a href="//twitter.com/wouaf_it" target="_blank" rel="noopener"><%= htmlWebpackPlugin.options.i18n.Twitter %></a> |
				<i class="fa fa-facebook-official"></i>&nbsp;<a href="https://www.facebook.com/wouafit/" target="_blank" rel="noopener">Facebook</a>
			</span>
		</nav>
	</footer>
</div>
