<div data-ui="activation">
	<div class="modal-header">
		...
		<h4 class="modal-title">{%= o.htmlWebpackPlugin.options.i18n['Activate your user account'] %}</h4>
	</div>
			...
			<fieldset class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" name="key"
						   placeholder="{%= o.htmlWebpackPlugin.options.i18n['Your activation key'] %}" />
				</div>
			</fieldset>
			<p class="text-xs-right"><button type="submit" class="btn btn-primary">{%= o.htmlWebpackPlugin.options.i18n['Activate your account'] %}</button></p>
		</form>
	</div>
