<div data-ui="login">
    ...
    <div class="modal-body">
		...
		<h4><i class="fa fa-facebook-official"></i> <%= htmlWebpackPlugin.options.i18n['Facebook account'] %></h4>
		<p class="text-xs-center"><button type="button" class="btn btn-secondary" data-dismiss="modal">Facebook connect</button></p>
		<small class="text-muted"><%= htmlWebpackPlugin.options.i18n['Facebook_account_details'] %></small>
		<hr />
		<h4><i class="fa fa-google-plus"></i> <%= htmlWebpackPlugin.options.i18n['Google account'] %></h4>
		<p class="text-xs-center"><button type="button" class="btn btn-secondary" data-dismiss="modal">Google connect</button></p>
		<hr />
		<h4 class="wouaf-it"><%= htmlWebpackPlugin.options.i18n['Wouaf IT account'] %></h4>
		<p class="text-xs-center"><button type="button" class="btn btn-primary btn-wrap"
									   data-href="create-account"
									   data-show="modal" data-target="#modalWindow"><%= htmlWebpackPlugin.options.i18n['New Wouaffer? Create your account!'] %></button></p>
